...
public enum Fx2JavaStrategy {
  SETTER {
    @Override
    public AbstractFX2Java create( @NotNull FXObject bindee, @NotNull Object binder ) {
  ...
  public abstract AbstractFX2Java create( @NotNull FXObject bindee, @NotNull Object binder );
}
